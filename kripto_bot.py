...
def get_ohlcv(symbol, timeframe, limit):
    # BtcTurk (Binance TR) API'si 'limit' parametresini desteklemiyor ve
    # bununla çağrılırsa INVALID_REQUEST_ERROR veriyor. Bu yüzden limit
    # göndermiyoruz; borsa kendi varsayılan mum sayısını döndürüyor,
    # ihtiyacımız olan son N mumu burada kendimiz kırpıyoruz.
    data = safe_call(exchange.fetch_ohlcv, symbol, timeframe=timeframe)
