...
# Binance TR için TRY bazlı minimum hacim sınırı (Örn: 50.000 TL veya ihtiyaca göre ayarlanabilir)
...
# ================= BINANCE TR =================
def get_tickers():
    # Binance TR API 24hr ticker adresi
    url = "https://www.trbinance.com/api/v3/ticker/24hr"
    try:
...
def get_klines(symbol):
    # Binance TR klines adresi (Global ile aynı yapıdadır)
    url = "https://www.trbinance.com/api/v3/klines"
    params = {
        "symbol": symbol,
        "interval": "15m",
        "limit": 100
...
def analyze_coin(symbol):
    ...
    # Son kapanan tam mumun hacmi üzerinden hesaplama
...
# ================= TARAMA =================
def scanner():
    print("🚀 Binance TR RSI MACD Radar başladı")
    ...
    while True:
        try:
            ...
            for coin in tickers:
                ...
                # Sadece TRY paritelerini filtrele
                ...
                if result:
                    ...
                    message = (
                        f"🚨 *BİNANCE TR POTANSİYEL HAREKET*\n\n"
                        f"🪙 Coin: #{symbol}\n"
...
if __name__ == "__main__":
    ...
    send_telegram("🔔 Binance TR Radar Test Mesajı: Sadece TRY pariteleri için aktif!")
