...
# TRY çiftleri için minimum 24 saatlik hacim
MIN_VOLUME_TRY = 100000

# USDT çiftleri için minimum 24 saatlik hacim
...
@app.route("/")
def home():
    return "🐋 Balina Radarı V3.1 Aktif!"
...
def analyze_coin(symbol):
    ...
    try:
        ...
        # Açık olan son mumu kullanmıyoruz.
        ...
        average_15m_volume = (
            sum(volumes_15m[-21:-1])
            /
            len(volumes_15m[-21:-1])
        )
        ...
        if 0 < momentum_30m < 7:
            ...
            reasons.append(
                "⚠️ 30 dk hareket fazla yükselmiş"
            )
        ...
        # 30 dakikada zaten çok fazla yükselmişse
        # erken sinyal olarak göndermiyoruz.

        if momentum_30m >= 15:

            return None

        # 1 saatte aşırı yükselmiş coinleri de ele.
