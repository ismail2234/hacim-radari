...
Bu surum Telegram bot_token / chat_id ISTEMEZ. Uretilen sinyaller
signals.jsonl dosyasina yazilir; zaten calisan uygulaman bu dosyayi
...
def write_signal(symbol: str, score_result: dict, message: str = None):
    """
    Sinyali signals.jsonl dosyasina bir satir olarak ekler.
    Kendi uygulaman bu dosyayi (veya Railway'de ayni volume'u) periyodik
    okuyup yeni satirlari kendi Telegram botuna iletebilir.
    """
...
if __name__ == "__main__":
    ...
    print("Sinyaller signals.jsonl dosyasina yazilacak (mevcut uygulaman oradan okuyabilir).")
