...
def record_signal(db, r):
    ...
    if history and history[0].get("phase") in ("PRE_BREAKOUT", "CONFIRMED", "VERY"):
...
def main():
    print("BALİNA RADARI V24 ana katmanı hazır.")
    print("V23 tarama döngüsü process_signals(db, signals) fonksiyonuna bağlanmalıdır.")
