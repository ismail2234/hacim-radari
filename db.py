...
class DB:
    ...
    def __init__(
        ...
        # Veritabanı şemasını bir kez oluştur.
    ...
    def _conn(self) -> sqlite3.Connection:
        """
        Her worker thread kendi SQLite bağlantısını kullanır.
        """
    ...
    def _write(self):
        """
        Sadece yazma işlemlerini kilitler.

        Okuma işlemleri global lock tarafından
        engellenmez.
        """
    ...
    def can_send(
        ...
        # Seviye yükseldiyse cooldown beklenmez.
        rank = {
            "WATCH": 0,
            "ONCU": 1,
            "BUY": 2,
