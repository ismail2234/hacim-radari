...
def analyze(cfg, client, dbs, market, item):
    ...
    # =====================================================
    # GERÇEK ERKENLİK / GEÇ KALMA FİLTRESİ
    # =====================================================
    ...
    # 3x üzeri hacim artık "erken" kabul edilmiyor.
    volume_early = (
        1.15 <= vr <= 3.00
    )
    ...
    # Hareket ilerledikçe erkenlik düşer.
    if move3 >= 3:
        early_score -= 15
