...
class DB:
    ...
    def can_send(self, symbol: str, level: str, cooldown: int) -> bool:
        ...
        old_level = row[2]
        # YENİ (V25): WATCH/ONCU açıkça sıralamaya eklendi -- böylece
        # bir coin WATCH'tan ÖNCÜ AL'a, ya da ÖNCÜ AL'dan AL'a yükseldiğinde
        # cooldown süresini beklemeden hemen gönderilir (yükseliş=daha
        # güvenilir bilgi, cooldown'a takılmamalı).
        rank = {"WATCH": 0, "ONCU": 1, "BUY": 2, "VERY": 3}
