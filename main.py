...
@app.route("/")
def home():
    return "Binance TRY Radar Aktif!"
...
# ================= TARAMA =================
def scanner():
    print("🚀 TRY Pariteleri RSI MACD Radar başladı")
    ...
    while True:
        try:
            ...
            for coin in tickers:
                ...
                # Sadece TRY ile biten pariteleri filtrele
...
if __name__ == "__main__":
    ...
    send_telegram("🔔 TRY Pariteleri Radar Test Mesajı: Sistem başarıyla başlatıldı!")
