...
class Features:
    ...
    # Fakeout
    fakeout: bool = False
    fakeout_reasons: list[str] = field(
        default_factory=list
    )

    # Trap
    trap: bool = False
    trap_reasons: list[str] = field(
        default_factory=list
    )
...
def calculate_features(
    ...
    # ALICI BASKISI
    # Binance kline:
    # index 7  = quote volume
    # index 10 = taker buy quote volume
    # --------------------------------------------------------
...
def decide_stage(
    ...
    # Fakeout veya tuzak varsa sinyal yok.
...
# ============================================================
# SCORING MODÜLÜ TESTİ
# ============================================================

if __name__ == "__main__":

    print(
        "🐋 Balina Radarı V26 scoring.py OK"
    )
