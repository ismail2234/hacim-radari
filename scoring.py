...
def score_entry_quality(
    ...
    # Kırılım gerçekleşmeden giriş kalitesi
    # "mükemmel giriş" olarak 100 olmasın.
...
def analyze(
    ...
    try:
        ...
        # Mevcut V23 davranışı korunuyor:
        # 5m işlem metriği son tamamlanmış 5m mumdan geliyor.
        trades5_sum = sum(
            trades5_list[-1:]
        )
        ...
        # ÖNEMLİ:
        # SETUP artık teyit streak'ini ilerletmiyor.
        #
        # Teyit sayacı yalnızca gerçek CONFIRMED/VERY
        # sinyallerinde artıyor.
        qualified = (
            stage in (
                "CONFIRMED",
                "VERY"
        ...
        if (
            level == "BUY"
            and streak < cfg.buy_streak
        ):
            level = "INTERNAL"

        if (
            level == "VERY"
            and streak < cfg.very_streak
        ):
            level = "INTERNAL"
