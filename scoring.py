...
def extract_features(
    ...
    squeeze = width <= 2.2 or (
        old_width > 0 and width < old_width * 0.80
    )
...
def trend_state_label(
    ...
    if not trend_ok:
        return "VERİ YOK"
    if d30 is not None and d90 is not None and d30 > 10 and d90 > 0:
        return "POZİTİF TREND"
    if d90 is not None and d30 is not None:
